namespace :govreviews do
  ...
  task crawl_greenbook_mayor_sub_agencies: :environment do
    ...
    subordinates_array.each do |subordinate_hash|
      ...
      pe = PublicEntity.create(name: subordinate_hash[:name], website: subordinate_hash[:website], address: subordinate_hash[:address], phone: subordinate_hash[:phone], description: subordinate_hash[:description], authority_level: "city", entity_type: "city agency", superior: mayor)
